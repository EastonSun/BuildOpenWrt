...
# 添加插件包
git clone https://github.com/dd0072/openwrt-packages.git
git clone https://github.com/dd0072/small-package.git
...
# sed -i "s/${orig_version}/R${date_version} by Yundong/g" package/lean/default-settings/files/zzz-default-settings
